...
void poseCallback(const geometry_msgs::PoseStamped::ConstPtr& msg){
    ...
    ROS_INFO_THROTTLE(1, "Updated pose");
    ROS_DEBUG("%f %f %f %f %f %f %f", pose.pose.position.x, pose.pose.position.y, pose.pose.position.z, pose.pose.orientation.x, pose.pose.orientation.y, pose.pose.orientation.z, pose.pose.orientation.w);
    updateModelState();
}
...
int main(int argc, char **argv){
    ...
    ros::NodeHandle n;
    ros::Time::sleepUntil(ros::Time(10));
